      ...
      <div className={styles.container}>
        <div className={styles.content}>
          <div className={styles.brand}>
            ...
            <p className={styles.description}>
              ...
              lượng cao, thiết kế hiện đại và giá cả hợp lý.
            </p>
          ...
          <div className={styles.section}>
            ...
            <div className={styles.links}>
              <Link href="/living-room" className={styles.link}>
                Phòng Khách
              </Link>
              <Link href="/bedroom" className={styles.link}>
                Phòng Ngủ
              </Link>
              <Link href="/dining" className={styles.link}>
                Bàn Ăn
              </Link>
              <Link href="/office" className={styles.link}>
                Văn Phòng
              </Link>
              <Link href="/outdoor" className={styles.link}>
                Ngoài Trời
              </Link>
            </div>
          </div>
          ...
          <div className={styles.section}>
            ...
            <div className={styles.contactItem}>
              ...
              <span>contact@furnihome.com</span>
            </div>
          </div>
        </div>
        ...
        <div className={styles.bottom}>
          <p className={styles.copyright}>
            © {currentYear} FurniHome. All rights reserved.
          </p>
